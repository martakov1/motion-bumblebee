...
export function dashboardAnimation(){
    ...
    // .from("#20",{duration:1, drawSVG:"0%", alpha: 0, ease:"none"})
    // .from("#30",{duration:1, drawSVG:"0%", alpha: 0, ease:"none"})
    // .from("#40",{duration:1, drawSVG:"0%", alpha: 0, ease:"none"})
    // .from("#0",{duration:1, drawSVG:"0%", alpha: 0, ease:"none"})
    // .from("#30",{duration:1, drawSVG:"0%", alpha: 0, ease:"none"})
    // .from("#50",{duration:1, drawSVG:"0%", alpha: 0, ease:"none"})
